...
{
    public class GiantBoomApiErrorHandler
    {
        ...
        private static GiantBoomErrorDetails ParseVsoErrorMessage(string response)
        {
            ...
            return new GiantBoomErrorDetails { Message = response };
        }
    }
}